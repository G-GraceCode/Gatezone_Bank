        ...
        <Sheet>
            ...
            <SheetContent side='left' className="border-none bg-white h-full">
                <Link href="/" className="mb-12 cursor-pointer flex items-center gap-2">
                    ...
                    />
                    <h1 className="text-24 font-ibm-plex-serif font-bold text-black-1">GateZone</h1>
                </Link>
            <div className="mobilenav-sheet">
                <SheetClose asChild>
                    ...
                    return (
                        ...
                        <p className={cn('tex-16 font-semibold text-black-2', {"text-white" : isActive})}>{item.label}</p>
                    </Link>
                    </SheetClose>
                    )
